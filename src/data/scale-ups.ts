...
export const meta: PageMeta = {
  ...
  description:
    'How delv. turns live deployment data into a value model your commercial team can run: for healthtech companies moving from pilot funding to recurrent budget.',
  ogImage: '/og/scale-ups.png',
};

export const hero: Hero = {
  heading: 'The proof is already in your deployment data.',
  sub: 'Twelve months of live use across several trusts, and a product generating data that nobody designed to answer &ldquo;so what?&rdquo;. The work is archaeology before it is modelling. We go and get the number, then build it so your team can run it again without us.',
  actions: [
  ...
  rows: [
    {
      ...
      body: 'Innovation money bought the pilot and everybody was pleased with it. Recurrent budget is a different conversation, with a different person, who wants a baseline, a comparator and a number that holds up in a finance review. Nothing you gathered during the pilot was designed for that meeting.',
    },
    {
      heading: 'The renewal that becomes a re-procurement',
      when: 'Usually six months before the contract ends',
      body: 'The trust that signed three years ago now has to justify keeping you: against a framework, against a rival, and against doing nothing. Nobody on your side can say what the deployment actually delivered, because nobody was asked to measure it at the time.',
    },
    {
      heading: 'The business case that does not travel',
      when: 'The first market that is not the NHS',
      body: 'Your argument was built once, for one system, around one budget. The first buyer outside it wants the same product justified against a different payer, a different cost base and a different evidence bar, and the deck you have does not convert.',
    },
  ] satisfies StageRow[],
};
  ...
  pillars: [
    {
      ...
      body: 'We audit what you already claim, sort the evidenced from the inherited, and pick the two or three numbers that would actually change a procurement conversation. This stage is quick, because you are not starting from nothing.',
    },
    {
      step: 'The bulk of it',
      heading: 'Go and get the number',
      body: 'We work in your deployment data, not around it. Where the data is thin we say so and find a defensible proxy rather than quietly stretching what is there. You get a model with an assumptions log, a stated basis for every figure, and conservative attribution that survives someone checking it.',
    },
    {
      step: 'What makes it repeat',
      heading: 'Build it so it runs again',
      body: 'A model only we can update is worth very little by the next renewal. We hand over something your commercial team can run on a new prospect, refresh as deployments mature, and defend in a room we are not in.',
    },
  ] satisfies Pillar[],
};
 ...
 * gets a governed estate. If those three ever read the same, the difference has
 * not been written hard enough.
 */
export const calculator = {
  ...
  paragraphs: [
    ...
    'The version that convinces is the one the buyer helped build. A prospect who has typed in their own numbers is arguing with their own arithmetic, not with your marketing.',
  ],
  caption:
    'Every input carries its default, its source and the range we consider defensible. Nothing in it is a number you cannot trace.',
};

export const cta: CtaBand = {
  heading: 'Start with a Value Model Build.',
  body: 'Six to eight weeks, fixed fee. We work in your deployment data and hand back one defensible number, the assumptions behind it, and the business case template that carries it into procurement. Your team owns it and can run it again.',
