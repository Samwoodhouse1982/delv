...
- **Superseded 18 Sep 2026, on Sam's copy edit.** The pair is now "15,000 downloads since launch" against "Saved 2 minutes per consultation, releasing 500 clinician hours every week", and the caption has gone with the arithmetic it carried. The two lines no longer share a unit or a period: downloads since launch cannot produce hours per week, so 500 is asserted rather than shown, and there is no longer an "Illustrative" note saying the figures are made up. That is a deliberate change of register — Before and After as two kinds of claim, not one claim worked through — and it is recorded here because it reverses a rule this file had settled twice. If it is ever reinstated, the caption field is still in the schema and the editor, both optional; it is the arithmetic that would need rebuilding, not the slot.
